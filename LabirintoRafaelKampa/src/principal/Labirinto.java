...
public class Labirinto {
	...
	public Stack<Movimentacao> caminho = new Stack<Movimentacao>();
	public Movimentacao inicio;
	
	
	protected static Stack<Labirinto> obterLabirintos() throws FileNotFoundException {
		Stack<Labirinto> labirintos = new Stack<Labirinto>();
